...
public class MainActivity extends Activity {
    ...
    private void initData() {
        ...
        addd("赵六", itemEntities);
        addd("赵六", itemEntities);
        addd("赵六", itemEntities);
        addd("赵六", itemEntities);

        for (int a = 0; a < 199; a++) {
            addd("赵六"+a, itemEntities);
    ...
    private void addd(String a, ArrayList listview) {
        ...
        urls_5.add("http://img.my.csdn.net/uploads/201410/19/1413698837_5654.jpg");
        urls_5.add("http://img.my.csdn.net/uploads/201410/19/1413698839_2302.jpg");
        ItemEntity entity6 = new ItemEntity(//
                "http://img.my.csdn.net/uploads/201410/19/1413698883_5877.jpg", a, "今天下雨了...", urls_5);
        listview.add(entity6);
    }
